# nvim-treesitter-queries-elvish

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-elvish/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-elvish/actions/workflows/validate.yml)

Neovim tree-sitter queries for **elvish**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-elvish",
...
- [ ] Changes are scoped to `elvish` — do not include files for other languages
